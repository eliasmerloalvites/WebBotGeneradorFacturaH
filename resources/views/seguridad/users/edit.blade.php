...
<div class="container ">
    <form action="{{route('usuario.update',$usuario->id)}}" method="post">
       ...
       <center> <button type="submit" class="btn btn-primary"><i class="fas fa-save mr-2"></i>Guardar</button>
        <a href="{{route('usuario.cancelar')}}" class="btn btn-danger" ><i class="fas fa-ban mr-2"></i>Regresar</a></center>
    </form>
